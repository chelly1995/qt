...
void Widget::paintGL( )
{
    ...
    // 방향성 때문에 순서에 일관성이 있다.
    static GLubyte front[]  = {3,2,0,1}; 	// front face
    static GLubyte back[]   = {7,6,4,5}; 	// back face
    static GLubyte top[]    = {3,2,7,6}; 	// top face
    static GLubyte bottom[] = {0,1,4,5}; 	// bottom face
    static GLubyte left[]   = {7,3,4,0}; 		// left face
