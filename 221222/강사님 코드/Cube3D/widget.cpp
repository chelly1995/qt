...
void Widget::paintGL( )
{
    ...
    // 방향성 때문에 순서에 일관성이 있다.
    static GLubyte front[]  = {,,,}; 	// front face
    static GLubyte back[]   = {,,,}; 	// back face
    static GLubyte top[]    = {,,,}; 	// top face
    static GLubyte bottom[] = {,,,}; 	// bottom face
    static GLubyte left[]   = {,,,}; 		// left face
    static GLubyte right[]  = {,,,}; 		// right face
