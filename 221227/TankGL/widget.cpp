    ...
    : QOpenGLWidget(parent)
{
    ...
    normalEnemy.xpos=normalEnemy.xpos*0.1;
    enemyAround=FALSE;
...
int Widget::loadGLTextures()            // Load Bitmaps And Convert To Textures
{
    ...
    QImage* image2 = new QImage("normalshot3.jpg");
...
//int Widget::loadGLTextures()
//{
//    int Status = FALSE;

//    QImage image1("barrel.bmp");
...
//    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER,GL_LINEAR);
//    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER,GL_LINEAR_MIPMAP_NEAREST);
//    gluBuild2DMipmaps(GL_TEXTURE_2D, 3,image2->size().width(), image2->size().height(), GL_RGB, GL_UNSIGNED_BYTE, data2);
...
//    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER,GL_LINEAR);
//    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER,GL_LINEAR_MIPMAP_NEAREST);
//    gluBuild2DMipmaps(GL_TEXTURE_2D, 3,image3->size().width(), image3->size().height(), GL_RGB, GL_UNSIGNED_BYTE, data3);
...
//    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER,GL_LINEAR);
//    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER,GL_LINEAR_MIPMAP_NEAREST);
//    gluBuild2DMipmaps(GL_TEXTURE_2D, 3, image4->size().width(), image4->size().height(), GL_RGB, GL_UNSIGNED_BYTE, data4);
